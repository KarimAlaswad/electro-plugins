...
(() => {
  ...
  // plugins/greet-go/frontend/greet-widget.jsx
  var import_jsx_runtime = __toESM(require_jsx_runtime());
  function GreetUI() {
    const [name, setName] = d2("World");
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => call("greet.hello"), children: "Hello" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { onClick: () => call("greet.bye"), children: "Bye" }),
      result && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("pre", { children: JSON.stringify(result, null, 2) })
    ] });
  }
  var GreetWidget = class extends HTMLElement {
    connectedCallback() {
      this.root = R(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GreetUI, {}), this);
    }
